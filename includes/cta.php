<section class="consultation-section">
    <div class="consultation-wrapper">
        ...
        <div class="consultation-content">
            ...
            <p class="consultation-legal">
                Нажимая на кнопку, Вы соглашаетесь с 
                <a href="/personal" class="consultation-link">политикой конфиденциальности</a><br>
                и даёте 
                <a href="/personal" class="consultation-link">согласие на обработку персональных данных</a>
            </p>
        </div>
    </div>
</section>